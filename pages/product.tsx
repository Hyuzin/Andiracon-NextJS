      ...
      <div className={` ${montserrat.className} px-3 md:px-20 lg:px-80 pt-10`}>
        <div id="uditch" className="pb-20">
          <Image
            ...
            height={500}
            alt="u-ditch"
            className=" w-[58vw] rounded-t-xl rounded-l-xl"
          />
          <div className="pl-10">
          ...
          <div className=" pl-10 text-justify text-[17px] ">
            <span className="font-medium"> U Ditch </span>Adalah salah satu
            produk beton precast yang digunakan untuk saluran drainase.
            Bentuknya menyerupai huruf U yang terbalik, sehingga dapat
            mengalirkan air dengan baik. <br /> <br /> Beton pra cetak U Ditch
            ...
            <br />
            Beton pra cetak U Ditch tersedia dalam berbagai ukuran dan
            spesifikasi sesuai dengan kebutuhan proyek. Harga beton pra cetak U
            Ditch bervariasi tergantung pada ukuran, kualitas, dan lokasi
            pengiriman. Untuk informasi lebih lanjut tentang beton pra cetak U
            Ditch, silakan hubungi kami di nomor telepon atau email yang
            tersedia di website kami ini.
          </div>
        </div>
        <div id="box" className="pb-20">
          <div className="overflow-hidden w-[58vw] h-[30vw] rounded-t-xl rounded-l-xl">
            <Image
              src="/assets/images/box-culvert.jpg"
              width={500}
              height={500}
              alt="box-culvert"
          ...
          <div className=" pl-10 text-justify text-[17px] ">
            ...
            persegi panjang. Box culvert biasanya digunakan untuk mengalirkan
            air di bawah jalan raya, rel kereta api, atau bangunan lainnya.{" "}
            <br /> <br /> Box culvert memiliki beberapa keunggulan, seperti
            kuat, tahan lama, mudah dipasang, dan fleksibel. Box culvert juga
            memiliki beberapa fungsi, seperti mengurangi banjir, melindungi
            tanah dari erosi, dan meningkatkan kualitas air.
          </div>
        </div>
        <div id="cover" className="pb-20">
          <div className="overflow-hidden w-[58vw] h-[30vw] rounded-t-xl rounded-l-xl">
            <Image
              src="/assets/images/cover-uditch.jpg"
              width={500}
              height={500}
              alt="cover-u-ditch"
              className=" w-full object-cover"
          ...
          <div className=" pl-10 text-justify text-[17px] ">
            ...
            ditch berfungsi untuk melindungi saluran u ditch dari kotoran,
            hujan, dan hewan liar. <br />
            ...
            berbagai ukuran dan bentuk cover u ditch sesuai dengan kebutuhan
            Anda. <br />
            <br /> Jika Anda tertarik untuk membeli cover u ditch dari kami,
            silakan hubungi kami melalui nomor telepon atau email yang tertera
            di website kami. Kami siap melayani Anda dengan profesional dan
            ramah.
          </div>
        </div>
        <div id="sheetpile" className="pb-20">
          <div className="overflow-hidden w-[58vw] h-[30vw] rounded-t-xl rounded-l-xl">
            <Image
              src="/assets/images/sheet-pile.jpg"
              width={500}
              height={500}
              alt="sheet-pile"
              className=" w-full object-cover"
        ...
        <div id="squarepile" className="pb-20">
          <div className="overflow-hidden w-[58vw] h-[30vw] rounded-t-xl rounded-l-xl">
            <Image
              src="/assets/images/square-pile.jpg"
              width={500}
              height={500}
              alt="square-pile"
              className=" w-full object-cover"
          ...
          <div className=" pl-10 text-justify text-[17px] ">
            <span className="font-medium"> Square Piles </span> adalah salah
            satu jenis tiang pancang yang digunakan untuk mendukung struktur
            bangunan di atas tanah yang tidak stabil atau lemah. Square Piles
            berbentuk persegi dan terbuat dari beton bertulang yang dicetak di
            pabrik. <br />
            ...
            Square Piles membutuhkan perencanaan dan perhitungan yang cermat
            untuk menjamin keamanan dan kinerja struktur bangunan. Square Piles
            juga memerlukan perawatan dan inspeksi berkala untuk mencegah
            kerusakan atau retak yang dapat mengurangi kapasitas beban tiang.
          </div>
        </div>
      </div>
    </Content>
