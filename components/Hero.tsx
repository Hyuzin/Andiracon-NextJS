...
const Hero = () => {
  return (
    <div className="relative h-[100vw] md:h-[56.25vw] " id="Home">
      ...
      >
        <p className="text-red-500 font-bold h-full leading-normal text-[25px] md:text-4xl lg:text-7xl drop-shadow-lg">
          PT. ANDIRACON
        </p>
        <p className="w-[90%] md:w-[60%] lg:w-[50%] font-medium lg:leading-10 text-white text-[15px] md:text-xl lg:text-3xl drop-shadow-lg">
